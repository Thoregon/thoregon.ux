...
export default function FlipCountDown() {
    ...
    function DrawText(){
        ...
        if(num == 5){
            ...
            CanvasContext.fillText("HOURS", param.hour1Position - 80*0.05*param.elementSize - offsetText, 150*param.elementSize);
        }
    ...
    this.Start = function(){
        ...
        const countDownCanvas = `
          <div style="top: 0px;">
            <img
              src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
              id="ResizingImage${this.CANVAS_NAME}"
              width="100%"
              height="1"
            >
            <canvas id="${this.CANVAS_NAME}"></canvas>
          </div>
        `;


        target.innerHTML = countDownCanvas;
/*
...
*/
        ...
        findWidth = target.querySelector('#ResizingImage'+ this.CANVAS_NAME );
        width = findWidth.width;

        Canvas = target.querySelector('#' + this.CANVAS_NAME);
